...
<vegachart schema-url="{{ site.baseurl }}json/building_boxplot.json" style="width: 100%"></vegachart>
...
<vegachart schema-url="{{ site.baseurl }}json/building_chart.json" style="width: 100%"></vegachart>
